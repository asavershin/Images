...
public class KafkaConf {
     ...
     */
    public static final String WIP_PRODUCER = "wipProducerTemplate";
    /**
     * Static final string constant for the Kafka template bean name.
     */
    public static final String DONE_PRODUCER = "doneProducerTemplate";
    /**
     ...
     */
    @Bean(WIP_PRODUCER)
    public KafkaTemplate<String, Task> wipProducerTemplate() {
     ...
     */
    @Bean(DONE_PRODUCER)
    public KafkaTemplate<String, DoneTask> doneProducerTemplate() {
        return new KafkaTemplate<>(producerFactory(
                props -> {
                    props.put(ProducerConfig.ACKS_CONFIG, "all");
                    props.put(ProducerConfig.RETRIES_CONFIG,
