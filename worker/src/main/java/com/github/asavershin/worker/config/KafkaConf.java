...
//     */
//    public static final String WIP_PRODUCER = "wipProducer";
//    /**
//     * Static final string constant for the Kafka template bean name.
//     */
//    public static final String DONE_PRODUCER = "doneProducer";
//    /**
...
//     */
//    @Bean(WIP_PRODUCER)
//    public KafkaTemplate<String, Task> wipProducer() {
...
//     */
//    @Bean(DONE_PRODUCER)
//    public KafkaTemplate<String, Task> doneProducer() {
//        return new KafkaTemplate<>(producerFactory(
//                props -> {
//                    props.put(ProducerConfig.ACKS_CONFIG, "all");
//                    props.put(ProducerConfig.RETRIES_CONFIG,
