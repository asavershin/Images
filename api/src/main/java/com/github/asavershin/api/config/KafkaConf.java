...
import com.github.asavershin.api.config.properties.ProducerProp;
import com.github.asavershin.api.domain.filter.FiltersForPublisher;
import com.github.asavershin.api.infrastructure.in.consumers.ImagesDoneMessage;
...
public class KafkaConf {
    ...
    public KafkaTemplate<String, FiltersForPublisher> allAcksKafkaTemplate() {
    ...
    private ProducerFactory<String, FiltersForPublisher> producerFactory(
     ...
     */
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, ImagesDoneMessage>
    kafkaListenerContainerFactory() {
        var props = properties.buildConsumerProperties(null);
        props.put(ConsumerConfig.ENABLE_AUTO_COMMIT_CONFIG, "false");
        props.put(ConsumerConfig.ISOLATION_LEVEL_CONFIG, "read_committed");
        ConcurrentKafkaListenerContainerFactory<String, ImagesDoneMessage>
                factory = new ConcurrentKafkaListenerContainerFactory<>();
        factory.setConsumerFactory(
                new DefaultKafkaConsumerFactory<>(
                        props,
                        new StringDeserializer(),
                        new JsonDeserializer<>(ImagesDoneMessage.class)
                )
        );
