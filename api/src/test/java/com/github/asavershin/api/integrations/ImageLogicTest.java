...
public class ImageLogicTest extends AbstractTest{
    ...
    public void storeImageTest(){
        ...
        assertNotNull(image);
        assertEquals(testUser.userId(), image.userId());
    ...
    public void storeImageWithIllegalExtensionTest(){
        // Given
        var testUser = user1();
        var credentials = testUser.userCredentials();
        registerNewUser.register(testUser);
    ...
    public void downloadImageTest() throws IOException {
        ...
        var multipartFile = ImageHelper.multipartFile1();
        registerNewUser.register(testUser);
        var imageId1 = imageService.storeImage(testUser.userId(), multipartFile);
        // When
        var image = imageService.downloadImage(imageId1, testUser.userId());
        // Then
